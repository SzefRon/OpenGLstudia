...
std::vector<Texture> vModel::loadMaterialTextures(aiMaterial *mat, aiTextureType type, std::string typeName)
{
    std::vector<Texture> textures;
...
unsigned int vModel::textureFromFile(const char *path, const std::string &directory, bool gamma)
{
